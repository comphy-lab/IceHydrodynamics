...
#define Mur_IceOcean 0. // this is the viscosity ratio of thin layer on top of ocean and ocean...
...
#define ElasticNumber 1e-1 // this is the ratio of the elastic modulus of the ice sheet to gravitational head: rho_Ocean*g*Lambda_Ocean
