...
#line 1 "./../src-IceHydro/log-conform-IceElastic.h"
/** Title: log-conform-IceElastic.h
...
event tracer_advection(i++)
{
    ...
    foreach() {
      ...
      */
      ...
      double fa = (f[]*(1.-fOcean[]) < (1e-6) ? 0.0: 1.);
